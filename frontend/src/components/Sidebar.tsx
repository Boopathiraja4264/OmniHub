  ...
  return (
    <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <nav>
        {section === 'finance' ? (
          <>
            <NavLink title="Dashboard" to="/" end className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            ...
            <NavLink title="Transactions" to="/transactions" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
              </svg>
              {!isCollapsed && <span>Transactions</span>}
            </NavLink>
            <NavLink title="Budgets" to="/budgets" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M22 12h-4l-3 9L9 3l-3 9H2"/>
              </svg>
              {!isCollapsed && <span>Budgets</span>}
            </NavLink>
            <NavLink title="Analytics" to="/analytics" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <>
            <NavLink title="Dashboard" to="/fitness" end className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/>
                <rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>
              </svg>
            ...
            <NavLink title="Workout Log" to="/fitness/workout" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M6 4v16M18 4v16M2 8h4M18 8h4M2 16h4M18 16h4"/>
              </svg>
              {!isCollapsed && <span>Workout Log</span>}
            </NavLink>
            <NavLink title="Exercises" to="/fitness/exercises" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <NavLink title="Weekly Plan" to="/fitness/weekly-plan" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <NavLink title="Weight" to="/fitness/weight" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div style={{ borderTop: "1px solid var(--border)", marginTop: 12, paddingTop: 12 }}>
          <NavLink title="Settings" to="/settings" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
